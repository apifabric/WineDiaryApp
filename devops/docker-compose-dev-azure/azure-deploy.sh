...
resourcename="winediaryapp"  # lower case, only
resourcegroup="winediaryapp_rg"
...
# git clone https://github.com/apilogicserver/winediaryapp.git
# cd winediaryapp
...
az group create --name winediaryapp_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group winediaryapp_rg --sku S1 --is-linux
az container create --resource-group winediaryapp_rg --name winediaryapp --image apilogicserver/winediaryapp:latest --dns-name-label winediaryapp --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//winediaryapp.westus.azurecontainer.io:5656'
