...
@Component({
  selector: 'Vineyard-home',
  templateUrl: './Vineyard-home.component.html',
  styleUrls: ['./Vineyard-home.component.scss']
})
export class VineyardHomeComponent implements AfterViewInit {
