...
@Component({
  selector: 'WineTasting-home',
  templateUrl: './WineTasting-home.component.html',
  styleUrls: ['./WineTasting-home.component.scss']
})
export class WineTastingHomeComponent implements AfterViewInit {
