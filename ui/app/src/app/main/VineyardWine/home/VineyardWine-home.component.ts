...
@Component({
  selector: 'VineyardWine-home',
  templateUrl: './VineyardWine-home.component.html',
  styleUrls: ['./VineyardWine-home.component.scss']
})
export class VineyardWineHomeComponent implements AfterViewInit {
