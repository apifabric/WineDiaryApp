...
@Component({
  selector: 'TasterTasting-home',
  templateUrl: './TasterTasting-home.component.html',
  styleUrls: ['./TasterTasting-home.component.scss']
})
export class TasterTastingHomeComponent implements AfterViewInit {
