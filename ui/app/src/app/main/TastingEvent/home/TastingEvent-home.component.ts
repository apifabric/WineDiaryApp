...
@Component({
  selector: 'TastingEvent-home',
  templateUrl: './TastingEvent-home.component.html',
  styleUrls: ['./TastingEvent-home.component.scss']
})
export class TastingEventHomeComponent implements AfterViewInit {
