...
@Component({
  selector: 'Taster-home',
  templateUrl: './Taster-home.component.html',
  styleUrls: ['./Taster-home.component.scss']
})
export class TasterHomeComponent implements AfterViewInit {
