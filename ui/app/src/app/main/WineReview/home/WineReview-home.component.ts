...
@Component({
  selector: 'WineReview-home',
  templateUrl: './WineReview-home.component.html',
  styleUrls: ['./WineReview-home.component.scss']
})
export class WineReviewHomeComponent implements AfterViewInit {
