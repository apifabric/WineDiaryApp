...
@Component({
  selector: 'Tasting-home',
  templateUrl: './Tasting-home.component.html',
  styleUrls: ['./Tasting-home.component.scss']
})
export class TastingHomeComponent implements AfterViewInit {
