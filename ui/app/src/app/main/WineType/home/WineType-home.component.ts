...
@Component({
  selector: 'WineType-home',
  templateUrl: './WineType-home.component.html',
  styleUrls: ['./WineType-home.component.scss']
})
export class WineTypeHomeComponent implements AfterViewInit {
