...
@Component({
  selector: 'TastingNote-home',
  templateUrl: './TastingNote-home.component.html',
  styleUrls: ['./TastingNote-home.component.scss']
})
export class TastingNoteHomeComponent implements AfterViewInit {
